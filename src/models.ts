...
export namespace Models {
  ...
  export type Log = {
    ...
    time: string;
    /**
     * Operating system code name. View list of [available options](https://github.com/nuvix-tech/nuvix/blob/master/docs/lists/os.json).
     */
    osCode: string;
    /**
    ...
    clientType: string;
    /**
     * Client code name. View list of [available options](https://github.com/nuvix-tech/nuvix/blob/master/docs/lists/clients.json).
     */
    clientCode: string;
    /**
     * Client name.
  ...
  export type File = {
    ...
    $updatedAt: string;
    /**
     * File permissions. [Learn more about permissions](https://nuvix.io/docs/permissions).
     */
    $permissions: string[];
    /**
     * File name.
