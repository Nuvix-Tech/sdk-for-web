...
export class CollectionQueryBuilder<T extends Client, Collection, CollectionsTypes> {
    ...
    */
    constructor(client: T, { collectionId, schema }: { collectionId: string, schema: string }) {
   ...
   */
    async find<Document extends Models.Document>(...queries: string[]): PromiseResponseType<T, Models.DocumentList<Document>> {
        return this.db.listDocuments<Document>(this.schema, this.collectionId, queries);
    }
    ...
    */
    async findById<Document extends Models.Document>(documentId: string, ...queries: string[]): PromiseResponseType<T, Document> {
        return this.db.getDocument<Document>(this.schema, this.collectionId, documentId, queries);
    }
    ...
    */
    async create<Document extends Models.Document>(documentId: string, data: Omit<Document, keyof Models.Document>, permissions?: string[]): PromiseResponseType<T, Document> {
        return this.db.createDocument<Document>(this.schema, this.collectionId, documentId, data, permissions);
    }
     ...
     */
    async update<Document extends Models.Document>(documentId: string, data: Partial<Omit<Document, keyof Models.Document>>, permissions?: string[]): PromiseResponseType<T, Document> {
        return this.db.updateDocument<Document>(this.schema, this.collectionId, documentId, data, permissions);
    }
