...
export type SelectQueryError<ErrorMessage extends string> = {
  Error: ErrorMessage;
};

export declare namespace DatabaseTypes {
  ...
  export type DatabaseWithOptions<
    Database,
          ...
          : // Check if the override is on a embedded relation (array)
            ...
            ? Row[K] extends any[]
              ? Array<
                  Simplify<
                    MergeDeep<
                      NonNullable<New[K][number]>,
                      NonNullable<Row[K][number]>
                    >
                  >
                >
              : New[K]
              ...
              ? IsPlainObject<NonNullable<Row[K]>> extends true
                ? // If they are, use the new override as source of truth for the optionality
                  ...
                  ? // If the override wants to preserve optionality
                    Simplify<
                      MergeDeep<NonNullable<New[K]>, NonNullable<Row[K]>>
                    > | null
